...
const company = [
  { label: "Tentang Kami", href: "/profile" },
...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/cognifera_edu/",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/cognifera-education",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-10">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { label: "Telepon", value: "+62 813 5551 5694" },
            { label: "Alamat", value: "Griya Sudiang Mandiri Blok B No. 12, Makassar" },
          ].map(({ label, value }) => (
            <div key={label}>
