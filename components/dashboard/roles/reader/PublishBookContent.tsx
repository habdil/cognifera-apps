...
interface PublishBookContentProps {
  userName?: string;
}

export const PublishBookContent = memo(({ userName }: PublishBookContentProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[var(--color-foreground)]">Terbitkan Buku</h1>
      ...
      {/* Submission Form */}
      {showForm && (
        <div className="bg-[var(--color-background)] rounded-lg shadow-md p-6 border border-[var(--color-border)]">
          <h2 className="text-xl font-semibold text-[var(--color-foreground)] mb-6">Submit Proposal Buku</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-[var(--color-border)] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[var(--color-background)] text-[var(--color-foreground)]"
                  required
                >
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-[var(--color-border)] rounded-lg p-6 text-center bg-[var(--color-muted)]">
                <Upload className="h-8 w-8 text-[var(--color-muted-foreground)] mx-auto mb-2" />
      ...
      {/* Submissions List */}
      <div className="bg-[var(--color-background)] rounded-lg shadow-md border border-[var(--color-border)]">
        <div className="p-6 border-b border-[var(--color-border)]">
          <h2 className="text-xl font-semibold text-[var(--color-foreground)]">Proposal Saya</h2>
        ...
        {submissions.length > 0 ? (
          <div className="divide-y divide-[var(--color-border)]">
            {submissions.map(submission => (
              <div key={submission.id} className="p-6 hover:bg-[var(--color-muted)]">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-[var(--color-muted-foreground)] mb-3 line-clamp-2">
                      {submission.description}
                    </p>

                    <div className="flex items-center text-sm text-[var(--color-muted-foreground)] space-x-4">
          ...
          <div className="p-12 text-center">
            <BookOpen className="h-12 w-12 text-[var(--color-muted-foreground)] mx-auto mb-4" />
...
PublishBookContent.displayName = 'PublishBookContent';