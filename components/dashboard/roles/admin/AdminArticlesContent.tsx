...
export const AdminArticlesContent = memo(() => {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-[var(--color-foreground)]">Articles Management</h1>
...
AdminArticlesContent.displayName = 'AdminArticlesContent';