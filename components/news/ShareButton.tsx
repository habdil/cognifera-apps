...
export function ShareButton({ title, text, url }: ShareButtonProps) {
  ...
  const shareToSocial = (platform: string) => {
    const shareUrl = url || (typeof window !== 'undefined' ? encodeURIComponent(window.location.href) : '');
    ...
    switch (platform) {
      case 'whatsapp':
        socialUrl = `https://wa.me/?text=${encodedText}%20${shareUrl}`;
        break;
      case 'twitter':
      ...
      case 'linkedin':
        ...
        break;
      case 'telegram':
        socialUrl = `https://t.me/share/url?url=${shareUrl}&text=${encodedText}`;
        break;
      default:
        return;
    }
  ...
  return (
    <div className="relative" ref={shareMenuRef}>
      ...
      {/* Share Dropdown Menu */}
      {showShareMenu && (
        <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 py-2 w-56 z-50">
          {/* Copy Link */}
          <button
