        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#layanan" className="hover:text-white transition-colors">Riset Pasar</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Analisis Data</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Konsultasi Bisnis</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Riset Akademik</a></li>
            </ul>
          </div>
